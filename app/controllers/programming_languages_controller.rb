...
class ProgrammingLanguagesController < ApplicationController
  ...
  def index
    ...
    if words.present?
      ...
      @programming_languages = @programming_languages.ordered
    end
  end
  ...
  def create
    ...
    respond_to do |format|
      if @programming_language.save
        format.html { redirect_to @programming_language, notice: t('programming_languages.was_created') }
  ...
  def update
    respond_to do |format|
      if @programming_language.update(programming_language_params)
        format.html { redirect_to @programming_language, notice: t('programming_languages.was_updated') }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to programming_languages_url, notice: t('programming_languages.was_deleted') }
  ...
  def programming_language_params
    params.require(:programming_language).permit(:name, :language_type, :designed_by)
  end
end
